...
func (m *MockAuthRepo) CreateUser(arg0 context.Context, arg1 service.UserSingUp) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthRepo) DeleteUserById(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) DeleteUserById(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUserById", reflect.TypeOf((*MockAuthRepo)(nil).DeleteUserById), arg0, arg1)
}
